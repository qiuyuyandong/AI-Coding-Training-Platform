...
import {
  ...
  type SkipReasonCode,
} from "@/components/PlanItemCompletionPanel";
import {
  TodayTaskPanel,
  decorateReasonCodes,
...
export type TodayPayloadType = TodayPayload;
export type EffortBoundaryValue = EffortBoundaryMinutes;
export type CompletionResultValue = CompletionResult;
export type SkipReasonCodeValue = SkipReasonCode;
export type DailySnapshotRowType = DailyPlanSnapshotRow;